...
export const images = {
  ...
  cities: {
    ...
    birmingham: {
      url: 'https://images.unsplash.com/photo-1570268894207-3de9fba7ac18?w=1200&h=800&fit=crop',
      alt: 'Birmingham cityscape - professional salon software for Birmingham salons',
    },
    edinburgh: {
      url: 'https://images.unsplash.com/photo-1555952594-c351dc26d1e2?w=1200&h=800&fit=crop',
      alt: 'Edinburgh castle and city - salon management software for Edinburgh salons',
    },
    glasgow: {
      url: 'https://images.unsplash.com/photo-1581971933862-26c48a330343?w=1200&h=800&fit=crop',
