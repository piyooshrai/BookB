        ...
        <div className="container">
          ...
          <div className="feature-item">
            <div className="feature-content">
              ...
              <p>
                Our software handles queue management automatically using proven best practices developed through working with thousands of salons worldwide. You get enterprise-level capabilities without enterprise-level costs or complexity.
              </p>
              <p>

                Whether you run a single-chair operation or manage multiple locations, BookB provides the features you need to implement effective queue management strategies starting day one. Our intuitive interface ensures your team can use the system productively without extensive training or technical expertise.

              </p>

              <p>

                Cloud-based access means you can manage operations from anywhere using any device with internet connection.
          ...
          <div className="feature-item">
            <div className="feature-content">
              ...
              <p>
                BookB provides comprehensive tools for queue management built specifically for salon operations. Our software automates routine tasks, streamlines workflows, and provides insights that help you make better business decisions.
              </p>
              <p>
              ...
              <p>
                Mobile apps for staff and clients ensure everyone stays connected and informed wherever they are. Integration with popular payment processors, accounting software, and marketing tools creates seamless workflows. Our support team provides responsive assistance ensuring you get help when you need it without long wait times.
              </p>
            </div>
            <div className="feature-visual">
              <Image
          ...
          <div className="feature-item">
            <div className="feature-content">
              ...
              <p>
                Implementing effective queue management delivers measurable returns through increased revenue, reduced costs, and improved efficiency. Salons using BookB report significant improvements in key performance metrics within first 90 days.
              </p>
              <p>
              ...
              <p>
                The best part is implementing BookB requires minimal disruption to your operations. We handle data migration from your existing systems ensuring smooth transition. Training takes hours not weeks thanks to intuitive design and comprehensive resources. Month-to-month pricing means no long-term commitment or expensive contracts.
              </p>
            </div>
            <div className="feature-visual">
              <Image
