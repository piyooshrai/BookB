...
export default function multi_location_salon_softwarePage() {
  return (
    <>
      <nav>
      ...
      <section className="hero">
        <div className="hero-content">
          <h1>Multi-Location Salon Software: Professional Software for Salons</h1>
          <p className="hero-subtitle">
            BookB provides powerful multi-location management capabilities designed specifically for modern salons. Streamline operations, increase efficiency, and grow your business with professional software built for beauty businesses of all sizes.
          </p>
      ...
      <section className="features">
        <div className="container">
          <h2>Why Choose BookB for Multi-Location Salon Software</h2>
          <p className="section-subtitle">Professional features designed specifically for salon operations</p>

          <div className="feature-item">
            <div className="feature-content">
              <h3>Complete Multi-Location Salon Software Solution</h3>
              <p>
                BookB delivers comprehensive multi-location management tools designed specifically for salon operations. Our software understands the unique needs of beauty businesses providing features that streamline daily operations, improve client satisfaction, and increase revenue.
              </p>
              <p>
              ...
              <p>
                Cloud-based access means you can manage your salon from anywhere using any device with internet connection. Integration with popular payment processors, marketing tools, and accounting software creates seamless workflows eliminating duplicate data entry and reducing errors.
              </p>
            </div>
          ...
          <div className="feature-item">
            <div className="feature-content">
              ...
              <p>
                <strong>Automated Workflows:</strong> Handle routine tasks like appointment reminders, follow-up messages, and birthday greetings freeing your team to focus on delivering excellent service.
              </p>
              <p>
                <strong>Comprehensive Reporting:</strong> Provides insights into business performance helping you make informed decisions about pricing, staffing, marketing, and growth strategies. Our support team provides responsive assistance via phone, email, and chat ensuring you get help when you need it without long wait times.
              </p>
            </div>
            <div className="feature-visual">
              <Image
          ...
          <div className="feature-item">
            <div className="feature-content">
              ...
              <p>
                <strong>Ongoing Support:</strong> Regular feature updates and improvements included at no additional cost. Security and data backup included ensuring your client information and business data stays protected. Money-back guarantee if you're not satisfied within first 30 days.
              </p>
            </div>
            <div className="feature-visual">
              <Image
