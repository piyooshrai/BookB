...
export default function CardiffSalonSoftware() {
  return (
    <>
      <nav>
      ...
      <section className="hero">
        <div className="hero-grid">
          ...
          <h1>Salon Software for Cardiff Hair & Beauty Businesses</h1>
          <p className="hero-subtitle">
            Complete salon management solution designed for Cardiff beauty professionals. BookB helps salons, spas, and beauty businesses across City Centre, Cardiff Bay, and Pontcanna streamline operations, increase revenue, and deliver exceptional client experiences. Trusted by hair salons, nail salons, barbershops, and day spas throughout Cardiff and the South Wales.
          </p>
      ...
      <section className="features">
        <div className="container">
          <h2>Why Cardiff Salons Choose BookB</h2>
          
          <div className="feature-item">
            <div className="feature-content">
              <h3>Built for Cardiff Beauty Businesses</h3>
              <p>
                Cardiff salons face unique challenges in today's competitive market. Rising commercial rents across City Centre and Cardiff Bay, sophisticated clients with high expectations, and intense competition from chains and independents all require professional management tools to stay profitable. BookB provides enterprise-level salon software at pricing independent Cardiff businesses can afford. Our platform handles everything from online booking and client management to point of sale and marketing automation, giving you more time to focus on delivering exceptional service. Salons throughout Pontcanna and surrounding areas rely on BookB to streamline operations, reduce no-shows, and build lasting client relationships. Whether you operate a single-chair studio or manage multiple locations across Cardiff, BookB scales with your business providing exactly the features you need without overwhelming complexity or enterprise pricing. Our cloud-based system works on any device with internet connection, letting you manage your business from anywhere. Automatic updates deliver new features regularly without manual software upgrades or IT support requirements. Dedicated customer success team provides responsive assistance ensuring you get maximum value from the platform.
              </p>
            </div>
            <div className="feature-visual">
              <div style={{padding: '60px', background: '#f8fafc', borderRadius: '8px'}}>
                [Cardiff Salons Visual]
              </div>
            </div>
          </div>
          ...
          <div className="feature-item">
            <div className="feature-content">
              <h3>Pricing for Cardiff Salons</h3>
              <p>
          ...
          <div className="feature-item">
            <div className="feature-content">
              <h3>Success Stories from Cardiff</h3>
              <p>
                Salons across Cardiff report significant improvements after implementing BookB. Hair salons in City Centre increased revenue by 30% through better booking conversion and reduced no-shows. Day spas in Cardiff Bay improved staff productivity by eliminating manual appointment books and paperwork. Nail salons in Pontcanna built stronger client relationships through personalized marketing and service history tracking. Multi-location operators streamlined management across their Cardiff salons with centralized oversight and reporting. Independent stylists grew from solo operations to team-based businesses using our staff management and scheduling tools. The common thread among successful BookB customers is commitment to providing excellent service while running efficient operations. Our software handles the administrative burden letting you focus on what matters most - delivering exceptional results that keep clients coming back. Many Cardiff salons recover their software investment within the first month through reduced no-shows alone. Additional revenue from improved booking conversion, retail sales, and client retention provides ongoing return on investment.
              </p>
            </div>
            <div className="feature-visual">
              <div style={{padding: '60px', background: '#f8fafc', borderRadius: '8px'}}>
      ...
      <section className="comparison">
        <div className="container">
          <h2>Ready to Transform Your Cardiff Salon?</h2>
          <p className="section-subtitle">Join Cardiff salons using BookB to streamline operations and increase revenue</p>
