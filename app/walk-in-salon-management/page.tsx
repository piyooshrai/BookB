...
export default function walk_in_salon_managementPage() {
  return (
    <>
      <Navigation />
      ...
      <section className="hero">
        <div className="hero-content">
          <h1>Walk-in Salon Management: Professional Software for Salons</h1>
          <p className="hero-subtitle">
            BookB provides powerful walk-in management capabilities designed specifically for modern salons. Streamline operations, increase efficiency, and grow your business with professional software built for beauty businesses of all sizes.
          </p>
      ...
      <section className="features">
        <div className="container">
          <h2>Why Choose BookB for Walk-in Salon Management</h2>
          <p className="section-subtitle">Professional features designed specifically for salon operations</p>

          <div className="feature-item">
            <div className="feature-content">
              <h3>Complete Walk-in Salon Management Solution</h3>
              <p>

                BookB delivers comprehensive walk-in management tools designed specifically for salon operations. Our software understands the unique needs of beauty businesses providing features that streamline daily operations, improve client satisfaction, and increase revenue.
