...
export default function salon_marketing_softwarePage() {
  return (
    <>
      <nav>
      ...
      <section className="hero">
        <div className="hero-content">
          <h1>Salon Marketing Software: Professional Software for Salons</h1>
          <p className="hero-subtitle">
            BookB provides powerful marketing automation capabilities designed specifically for modern salons. Streamline operations, increase efficiency, and grow your business with professional software built for beauty businesses of all sizes.
          </p>
      ...
      <section className="features">
        <div className="container">
          <h2>Why Choose BookB for Salon Marketing Software</h2>
          <p className="section-subtitle">Professional features designed specifically for salon operations</p>

          <div className="feature-item">
            <div className="feature-content">
              <h3>Complete Salon Marketing Software Solution</h3>
              <p>

                BookB delivers comprehensive marketing automation tools designed specifically for salon operations. Our software understands the unique needs of beauty businesses providing features that streamline daily operations, improve client satisfaction, and increase revenue.
