...
export default function salon_staff_managementPage() {
  return (
    <>
      <nav>
      ...
      <section className="hero">
        <div className="hero-content">
          <h1>Salon Staff Management: Professional Software for Salons</h1>
          <p className="hero-subtitle">
            BookB provides powerful staff management capabilities designed specifically for modern salons. Streamline operations, increase efficiency, and grow your business with professional software built for beauty businesses of all sizes.
          </p>
      ...
      <section className="features">
        <div className="container">
          <h2>Why Choose BookB for Salon Staff Management</h2>
          <p className="section-subtitle">Professional features designed specifically for salon operations</p>

          <div className="feature-item">
            <div className="feature-content">
              <h3>Complete Salon Staff Management Solution</h3>
              <p>

                BookB delivers comprehensive staff management tools designed specifically for salon operations. Our software understands the unique needs of beauty businesses providing features that streamline daily operations, improve client satisfaction, and increase revenue.
