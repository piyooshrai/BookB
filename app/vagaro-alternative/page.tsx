...
export default function VagaroAlternative() {
  return (
    <>
      <nav>
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          <h1>The Vagaro Alternative Without Marketplace Commission</h1>
          <p className="hero-subtitle">
            BookB delivers professional salon management software with zero booking commission, complete client data ownership, and transparent pricing. No marketplace competition for your clients, no hidden fees on transactions, no compromises on features. Get the power you need without surrendering control of your business.
          </p>
          <div className="cta-buttons">
            <a href="#trial" className="btn btn-primary">Start Free Trial</a>
            <a href="/pricing" className="btn btn-secondary">View Pricing</a>
          </div>
          <p className="trust-line">Join 10,000+ salons who own their client relationships</p>
        </div>
      ...
      <section className="comparison">
        <div className="container">
          <h2>BookB vs Vagaro: The Real Cost Analysis</h2>
          <p className="section-subtitle">Calculate the true cost of marketplace dependency</p>

          <div className="comparison-table">
            <div className="comparison-row comparison-header">
              <div className="feature-name">Cost Factor</div>
              <div className="competitor-value">Vagaro</div>
              <div className="bookb-value">BookB</div>
            </div>
            <div className="comparison-row">
              <div className="feature-name">Monthly Fee</div>
              <div className="competitor-value">$25-30</div>
              <div className="bookb-value">$99</div>
            </div>
            <div className="comparison-row">
              <div className="feature-name">Booking Commission</div>
              <div className="competitor-value">Variable%</div>
              <div className="bookb-value">$0</div>
            </div>
            <div className="comparison-row">
              <div className="feature-name">Marketplace Fees</div>
              <div className="competitor-value">Up to 10%</div>
              <div className="bookb-value">$0</div>
            </div>
            <div className="comparison-row">
            ...
            <div className="comparison-row">
              <div className="feature-name">Competitor Marketing</div>
              <div className="competitor-value">To your clients</div>
              <div className="bookb-value">Never</div>
            </div>
            <div className="comparison-row savings-row">
              <div className="feature-name"><strong>Annual Cost (150 bookings/mo)</strong></div>
              <div className="competitor-value">$2,160+</div>
      ...
      <section className="features">
        <div className="container">
          <h2>Why Salons Leave Vagaro's Marketplace for BookB</h2>
      ...
      <section className="comparison">
        <div className="container">
          <h2>Common Questions from Vagaro Users</h2>
          <p className="section-subtitle">Everything you need to know about switching to BookB</p>

          <div style={{maxWidth: '800px', margin: '0 auto', textAlign: 'left'}}>
            <div style={{marginBottom: '2rem'}}>
              <h3 style={{fontSize: '20px', marginBottom: '0.5rem'}}>How do I migrate my client list from Vagaro?</h3>
              <p style={{color: 'var(--text-light)', lineHeight: '1.7'}}>
                BookB's migration team exports your complete Vagaro database including clients, appointments, service history, and notes. Color formulas, photos, and preferences transfer automatically. Package balances and gift card values migrate precisely. Historical data remains searchable for reporting and reference. The process typically completes within 48 hours with minimal salon involvement required.
              </p>
            </div>

            <div style={{marginBottom: '2rem'}}>
              <h3 style={{fontSize: '20px', marginBottom: '0.5rem'}}>Will I lose marketplace visibility by leaving Vagaro?</h3>
              <p style={{color: 'var(--text-light)', lineHeight: '1.7'}}>
                BookB helps you build independent online visibility through Google My Business optimization, local SEO, social media presence, and review generation. Most salons find they acquire clients more profitably through owned channels than marketplace dependency. Your existing clients follow you easily with communication support during transition.
              </p>
            </div>

            <div style={{marginBottom: '2rem'}}>
              <h3 style={{fontSize: '20px', marginBottom: '0.5rem'}}>What about clients who found me through Vagaro marketplace?</h3>
              <p style={{color: 'var(--text-light)', lineHeight: '1.7'}}>
                Clients acquired through Vagaro marketplace are your clients. BookB helps maintain those relationships without ongoing marketplace fees. Email and SMS campaigns communicate your new booking system. Website integration provides seamless booking. Social media tools keep you visible to potential clients. Many salons report better client retention after leaving marketplace dependency.
              </p>
            </div>

            <div style={{marginBottom: '2rem'}}>
              <h3 style={{fontSize: '20px', marginBottom: '0.5rem'}}>Is BookB really worth the higher monthly cost?</h3>
              <p style={{color: 'var(--text-light)', lineHeight: '1.7'}}>
                While BookB's monthly fee is higher than Vagaro's base price, you save money by avoiding booking commissions and marketplace fees. For salons with 100+ monthly appointments, BookB typically costs less overall while providing superior features, complete data ownership, and no competitor marketing to your clients. Calculate your true costs including all Vagaro fees for accurate comparison.
              </p>
            </div>
            ...
            <div style={{marginBottom: '2rem'}}>
              ...
              <p style={{color: 'var(--text-light)', lineHeight: '1.7'}}>
                Yes, BookB integrates with Square, Stripe, and traditional merchant accounts. You maintain existing processor relationships and negotiated rates. Card readers typically work with simple configuration. If you prefer integrated processing, BookB offers competitive transparent pricing with no hidden markups or transaction fees beyond actual processing costs.
              </p>
            </div>

            <div style={{marginBottom: '2rem'}}>
              <h3 style={{fontSize: '20px', marginBottom: '0.5rem'}}>How does online booking compare to Vagaro's?</h3>
              <p style={{color: 'var(--text-light)', lineHeight: '1.7'}}>
                BookB's online booking is fully customizable with your branding without competitor advertising. Clients book services, select stylists, purchase packages, and prepay for appointments. The booking widget embeds on your website or works standalone. Mobile optimization ensures easy booking from any device. Real-time availability prevents conflicts. Service add-ons increase average tickets during booking.
              </p>
            </div>

            <div style={{marginBottom: '2rem'}}>
              <h3 style={{fontSize: '20px', marginBottom: '0.5rem'}}>What happens to my online reviews?</h3>
              <p style={{color: 'var(--text-light)', lineHeight: '1.7'}}>
                Your Vagaro reviews remain on that platform. BookB helps you build independent review presence on Google, Facebook, and beauty-specific platforms. Automated review requests send after appointments. Review monitoring alerts you to new feedback. Response templates help maintain professional engagement. You build owned review assets that can't be controlled or monetized by marketplace platforms.
              </p>
            </div>
            ...
            <div style={{marginBottom: '2rem'}}>
              ...
              <p style={{color: 'var(--text-light)', lineHeight: '1.7'}}>
                Yes, BookB offers a 30-day free trial with complete feature access. Import your Vagaro data into the trial environment. Test all features with your actual service menu and staff. Run BookB alongside Vagaro during evaluation. Our team provides hands-on training and implementation support during trial. Cancel anytime if it's not the right fit. No credit card required to start.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="pricing">
        <div className="container">
          <h2>Honest Pricing With Zero Commission</h2>
          <p className="section-subtitle">One flat fee, unlimited bookings, complete ownership</p>
