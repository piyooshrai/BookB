...
export default function salon_crm_softwarePage() {
  return (
    <>
      <nav>
      ...
      <section className="hero">
        <div className="hero-content">
          <h1>Salon CRM Software: Professional Software for Salons</h1>
          <p className="hero-subtitle">
            BookB provides powerful client relationship management capabilities designed specifically for modern salons. Streamline operations, increase efficiency, and grow your business with professional software built for beauty businesses of all sizes.
          </p>
      ...
      <section className="features">
        <div className="container">
          <h2>Why Choose BookB for Salon CRM Software</h2>
