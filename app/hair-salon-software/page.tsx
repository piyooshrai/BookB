        ...
        <div className="container">
          ...
          <div className="feature-item">
            <div className="feature-content">
              ...
              <p>
                hair salons face unique challenges in today's competitive market. Modern clients expect professional service, convenient booking options, and seamless experiences from first contact through checkout and beyond. Successful hair salons need robust management tools that handle appointments, payments, client relationships, and marketing without overwhelming complexity or enterprise pricing. BookB solves this problem by providing professional software designed specifically for beauty industry operations at pricing independent businesses can afford. Our platform understands the specific workflow requirements of hair salons including service timing, product usage, client preferences, and stylists schedules. You get enterprise-level capabilities without enterprise-level costs or complexity enabling you to compete effectively against larger chains while maintaining your independent identity. Whether you operate solo or manage a team of stylists, BookB scales with your business providing exactly the features you need without overwhelming you with unnecessary complexity. Our intuitive interface ensures your team can use the system productively without extensive training or technical expertise. Cloud-based access means you can manage your business from anywhere using any device with internet connection. Automatic updates deliver new features and improvements regularly without manual software upgrades or IT support requirements. Dedicated customer success team provides responsive assistance ensuring you get maximum value from the platform.
              </p>
            </div>
          ...
          <div className="feature-item">
            <div className="feature-content">
              ...
              <p>
                BookB offers transparent pricing without long-term contracts or hidden fees making it accessible for hair salons at any stage of growth. Starter plan at £15/month provides complete management for solo stylists including unlimited appointments, online booking, client management, basic POS, and email support. Professional plan at £35/month supports up to 5 stylists adding advanced analytics, inventory management, email marketing, custom branding, and priority support. Business plan at £75/month handles up to 15 stylists with multi-location support, advanced reporting, API access, loyalty programs, and dedicated account manager. Enterprise plan at £150/month provides unlimited stylists, white-label options, custom integrations, 99.9% uptime SLA, and 24/7 phone support. All plans include unlimited appointments, clients, and bookings ensuring predictable costs as your business grows. Free 14-day trial lets you test everything before committing. Month-to-month billing means no long-term contracts or cancellation fees. Migration assistance helps transfer data from existing systems smoothly. Training and onboarding ensure your team masters the platform quickly. UK-based customer support provides responsive assistance during business hours via phone, email, and live chat. Money-back guarantee protects your investment if you are not completely satisfied within first 30 days. Pay annually and save 20% on any plan making the Professional plan just £336/year instead of £420.
              </p>
            </div>
            <div className="feature-visual">
              <div style={{padding: '60px', background: '#f8fafc', borderRadius: '8px'}}>
