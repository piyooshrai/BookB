export default function salon_receptionist_softwarePage() {
  return (
    <>
      <nav>
      ...
      <section className="hero">
        <div className="hero-content">
          <h1>Salon Receptionist Software</h1>
          <p className="hero-subtitle">
            Complete guide to front desk management for modern salons. Learn proven strategies, best practices, and practical solutions that help beauty businesses improve operations, increase revenue, and deliver better client experiences. BookB provides the software tools you need to implement these strategies effectively.
          </p>
      ...
      <section className="features">
        <div className="container">
          <h2>Understanding Salon Receptionist Software</h2>
      ...
      <section className="comparison">
        <div className="container">
          ...
          <p className="section-subtitle">Join 1,000+ salons using BookB for front desk management</p>
