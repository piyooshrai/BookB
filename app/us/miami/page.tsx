...
export default function MiamiSalonSoftware() {
  return (
    <>
      <Navigation />
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          <h1>Salon Software for Miami Hair & Beauty Businesses</h1>
          <p className="hero-subtitle">
            BookB helps Miami salons manage appointments, clients, staff, and payments with powerful cloud-based software designed specifically for US beauty businesses. From South Beach to Wynwood, Brickell and beyond, Miami salons trust BookB for reliable, affordable salon management that works perfectly with US payment systems and local business practices.
          </p>
          <div className="cta-buttons">
            <a href="#trial" className="btn btn-primary">Start Free Trial</a>
            <a href="/pricing" className="btn btn-secondary">View Pricing</a>
          </div>
          <p className="trust-line">Trusted by 300+ Miami salons and growing</p>
        </div>
          <div className="hero-image">
            <Image
              src={images.cities.miami.url}
              alt={images.cities.miami.alt}
              width={600}
              height={400}
              priority
      ...
      <section className="features">
        <div className="container">
          <h2>Perfect for Miami's Beauty Market</h2>
      ...
      <section className="pricing">
        <div className="container">
          <h2>Affordable Pricing for Miami Salons</h2>
          <p className="section-subtitle">Professional software at prices that work for Miami businesses</p>
