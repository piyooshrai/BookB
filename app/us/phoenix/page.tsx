      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <div className="hero-image">
            <Image
              src={images.cities.phoenix.url}
              alt={images.cities.phoenix.alt}
              width={600}
              height={400}
              priority
          ...
          <div className="feature-item">
            <div className="feature-content">
              ...
              <p>
                ...
                Phoenix's beauty industry requires software that understands local business practices and regulatory requirements. BookB provides features specifically designed for US salons including automatic sales tax calculation and reporting that handles Phoenix's tax requirements.
              ...
              <p>
                ...
                Online booking works perfectly with US phone number formats, ZIP codes, and address conventions familiar to American clients throughout Phoenix. Appointment scheduling accounts for US federal holidays and state holidays automatically preventing booking conflicts during major holidays when salons may close.

              </p>

              <p>

                Staff scheduling respects US employment law including Fair Labor Standards Act overtime rules, meal break requirements, and wage and hour regulations applicable to Phoenix beauty businesses operating across the metro area. Payroll reporting generates data formatted for US accounting software like QuickBooks and payroll providers like ADP serving Phoenix businesses from independent stylists to multi-location salon chains throughout the region.

              </p>

              <p>

                Tax compliance features help Phoenix salons meet federal and state tax obligations including income tax withholding, unemployment insurance, and workers compensation requirements specific to operations in the area. Marketing communications comply with CAN-SPAM regulations and US consumer protection laws ensuring your promotional campaigns stay compliant while building your Phoenix client base through email, text, and social media outreach.

              </p>

              <p>

                Currency displays in US dollars with proper formatting and no international currency complications for straightforward American business operations. Time displays in 12-hour format with AM/PM matching American preferences familiar to all Phoenix residents.

              </p>

              <p>

                Date formats follow US conventions with month/day/year preventing confusion that could cause appointment booking errors in your busy Phoenix salon schedule.
          ...
          <div className="feature-item">
            <div className="feature-content">
              ...
              <p>
                ...
                Phoenix clients demand sophisticated online booking capabilities matching the digital experiences they enjoy from other service providers. BookB provides mobile-optimized online booking that works perfectly on smartphones wherever clients access their devices 24/7.

              </p>

              <p>

                Real-time availability shows exactly which appointment slots remain open preventing the frustration of booking requests that get declined hours later. Stylist profiles include photos, specialties, portfolios, and client reviews helping Phoenix clients choose the right professional for their specific needs.

              </p>

              <p>

                Service descriptions explain treatments clearly with duration estimates and pricing so clients understand exactly what they're booking. Before and after galleries showcase your salon's work building confidence in new clients considering your Phoenix salon for the first time.
              ...
              <p>
                ...
                Package purchasing during online booking encourages prepayment and commitment from Phoenix clients. Gift card purchases online generate revenue and introduce new clients through word-of-mouth referrals.
          ...
          <div className="feature-item">
            <div className="feature-content">
              ...
              <p>
                ...
                Running a profitable salon in Phoenix requires understanding your numbers with competitive pressures throughout the area. BookB provides comprehensive reporting helping Phoenix salon owners make data-driven decisions.
