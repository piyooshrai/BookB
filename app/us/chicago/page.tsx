        ...
        <div className="container">
          ...
          <div className="feature-item">
            <div className="feature-content">
              ...
              <p>
                Chicago's beauty industry requires software that understands local business practices and regulatory requirements. BookB provides features specifically designed for US salons including automatic sales tax calculation and reporting that handles Chicago's tax requirements. Price display follows US conventions with tax-exclusive pricing shown to clients with tax calculated at checkout matching standard American retail practices. Payment processing integrates seamlessly with US banks and card processors including Square, Stripe, and traditional merchant accounts processing credit cards, debit cards, Apple Pay, Google Pay, and other payment methods. Online booking works perfectly with US phone number formats, ZIP codes, and address conventions familiar to American clients throughout Chicago. Appointment scheduling accounts for US federal holidays and state holidays automatically preventing booking conflicts during major holidays when salons may close. Staff scheduling respects US employment law including Fair Labor Standards Act overtime rules, meal break requirements, and wage and hour regulations applicable to Chicago beauty businesses operating across the metro area. Payroll reporting generates data formatted for US accounting software like QuickBooks and payroll providers like ADP serving Chicago businesses from independent stylists to multi-location salon chains throughout the region. Tax compliance features help Chicago salons meet federal and state tax obligations including income tax withholding, unemployment insurance, and workers compensation requirements specific to operations in the area. Marketing communications comply with CAN-SPAM regulations and US consumer protection laws ensuring your promotional campaigns stay compliant while building your Chicago client base through email, text, and social media outreach. Currency displays in US dollars with proper formatting and no international currency complications for straightforward American business operations. Time displays in 12-hour format with AM/PM matching American preferences familiar to all Chicago residents. Date formats follow US conventions with month/day/year preventing confusion that could cause appointment booking errors in your busy Chicago salon schedule.
              </p>
            </div>
          ...
          <div className="feature-item">
            <div className="feature-content">
              ...
              <p>
                Chicago clients demand sophisticated online booking capabilities matching the digital experiences they enjoy from other service providers. BookB provides mobile-optimized online booking that works perfectly on smartphones wherever clients access their devices 24/7. Real-time availability shows exactly which appointment slots remain open preventing the frustration of booking requests that get declined hours later. Stylist profiles include photos, specialties, portfolios, and client reviews helping Chicago clients choose the right professional for their specific needs. Service descriptions explain treatments clearly with duration estimates and pricing so clients understand exactly what they're booking. Before and after galleries showcase your salon's work building confidence in new clients considering your Chicago salon for the first time. Location information helps clients plan their journey and find your salon easily whether driving or using public transportation. Contactless deposit payments secure appointments reducing no-shows common in busy markets where clients juggle demanding schedules. Automatic appointment reminders via SMS and email reduce no-shows without requiring staff time making confirmation calls. Rescheduling and cancellation through client self-service reduces phone interruptions during busy salon operating hours. Package purchasing during online booking encourages prepayment and commitment from Chicago clients. Gift card purchases online generate revenue and introduce new clients through word-of-mouth referrals.
              </p>
            </div>
            <div className="feature-visual">
              <div style={{padding: '60px', background: '#f8fafc', borderRadius: '8px'}}>
