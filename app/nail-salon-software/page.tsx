    ...
    <>
      ...
      <section className="hero">
        <div className="hero-grid">
          ...
          <h1>Nail Salon Management Software</h1>
          <p className="hero-subtitle">
            Complete management solution designed specifically for nail salons. BookB helps beauty professionals streamline operations, increase revenue, and deliver exceptional client experiences. Trusted by nail salons worldwide, our platform handles everything from online booking and client management to point of sale and marketing automation.
          </p>
          ...
          <div className="hero-image">
            <Image
              src={images.nailSalon.url}
              alt={images.nailSalon.alt}
              width={600}
              height={400}
              priority
      ...
      <section className="features">
        <div className="container">
          <h2>Why nail salons Choose BookB</h2>
          ...
          <div className="feature-item">
            <div className="feature-content">
              ...
              <p>
                ...
                nail salons face unique challenges in today's competitive market. Modern clients expect professional service, convenient booking options, and seamless experiences from first contact through checkout and beyond.

              </p>

              <p>

                Successful nail salons need robust management tools that handle appointments, payments, client relationships, and marketing without overwhelming complexity or enterprise pricing. BookB solves this problem by providing professional software designed specifically for beauty industry operations at pricing independent businesses can afford.

              </p>

              <p>

                Our platform understands the specific workflow requirements of nail salons including service timing, product usage, client preferences, and technicians schedules. You get enterprise-level capabilities without enterprise-level costs or complexity enabling you to compete effectively against larger chains while maintaining your independent identity.

              </p>

              <p>

                Whether you operate solo or manage a team of technicians, BookB scales with your business providing exactly the features you need without overwhelming you with unnecessary complexity. Our intuitive interface ensures your team can use the system productively without extensive training or technical expertise.
          ...
          <div className="feature-item">
            <div className="feature-content">
              ...
              <p>
                ...
                BookB provides comprehensive tools designed specifically for nail salons operations. Online booking accepts appointments 24/7 through your website, social media, and Google eliminating phone tag and capturing clients who book outside business hours.
              ...
              <p>
                ...
                Staff scheduling coordinates team calendars, time off, and availability preventing conflicts and optimizing capacity. Performance tracking shows revenue, client retention, and productivity metrics per technician.
          ...
          <div className="feature-item">
            <div className="feature-content">
              ...
              <p>
                ...
                Growing your nail salons business requires effective marketing that brings in new clients while keeping existing ones engaged. BookB provides professional marketing automation tools that work automatically in the background.
          ...
          <div className="feature-item">
            <div className="feature-content">
              ...
              <p>
                ...
                BookB offers transparent pricing without long-term contracts or hidden fees making it accessible for nail salons at any stage of growth. Starter plan at £15/month provides complete management for solo technicians including unlimited appointments, online booking, client management, basic POS, and email support.

              </p>

              <p>

                Professional plan at £35/month supports up to 5 technicians adding advanced analytics, inventory management, email marketing, custom branding, and priority support. Business plan at £75/month handles up to 15 technicians with multi-location support, advanced reporting, API access, loyalty programs, and dedicated account manager.

              </p>

              <p>

                Enterprise plan at £150/month provides unlimited technicians, white-label options, custom integrations, 99.9% uptime SLA, and 24/7 phone support. All plans include unlimited appointments, clients, and bookings ensuring predictable costs as your business grows.
      ...
      <section className="comparison">
        <div className="container">
          ...
          <p className="section-subtitle">Join nail salons worldwide using BookB to streamline operations and increase revenue</p>
