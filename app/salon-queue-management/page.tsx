  ...
  return (
    <>
      ...
      <section className="features">
        <div className="container">
          <h2>Why Choose BookB for Salon Queue Management</h2>
          <p className="section-subtitle">Professional features designed specifically for salon operations</p>

          <div className="feature-item">
            <div className="feature-content">
              <h3>Complete Salon Queue Management Solution</h3>
              <p>

                BookB delivers comprehensive queue management tools designed specifically for salon operations. Our software understands the unique needs of beauty businesses providing features that streamline daily operations, improve client satisfaction, and increase revenue.
